...
with open('avocado.csv', 'r') as rfile, \
    open('avocado_state.csv', 'w', newline='') as wfile:
        reader = csv.reader(rfile)
        writer = csv.writer(wfile)

        headings = 'index,Date,AveragePrice,Total Volume,4046,4225,4770,Total Bags,Small Bags,Large Bags,XLarge Bags,type,year,region,state'
